...
Vagrant.configure(2) do |config|
  ...
  config.vm.provision "shell", privileged: false, inline: <<-SHELL
    ...
    git clone https://github.com/carlospuga/vagrant-neutron.git
    #git clone -b stable/newton https://git.openstack.org/openstack/octavia
    #cd octavia/devstack/samples/singlenode
    cd ~/vagrant-neutron
